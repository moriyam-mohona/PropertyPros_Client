const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-300 text-base-content flex flex-wrap justify-between">
      <div className="flex items-center gap-2 mb-6 w-full md:w-auto">
        <img
          src="/Assets/logo.png"
          alt="PropertyPros Logo"
          className="w-12 h-12"
        />
        <div>
          <p className="text-2xl font-bold">PropertyPros</p>
          <p className="text-sm">Providing reliable homes since 1992</p>
        </div>
      </div>

      <nav className="mb-6 w-full md:w-auto">
      ...
      <div className="w-full md:w-auto">
        <span className="footer-title text-lg font-bold mb-2 block">
          Social
        </span>
